        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="text-center backdrop-blur-sm bg-white/5 rounded-3xl p-4 border border-white/10">
              <div className="w-16 h-16 bg-purple-400/30 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto mb-3">
                <AcademicCapIcon className="w-8 h-8 text-white" />
              </div>
              <h2 className="text-lg font-bold text-white mb-1">Prof. Ana Silva</h2>
              <p className="text-purple-300 mb-2">Especialista em Oratória</p>
            ...
            <div className="text-center backdrop-blur-sm bg-white/5 rounded-3xl p-4 border border-white/10">
              ...
              <p className="text-purple-300 mb-2">Especialista em Expressão</p>
              <p className="text-white/70 text-sm">
            ...
            <div className="text-center backdrop-blur-sm bg-white/5 rounded-3xl p-4 border border-white/10">
              ...
              <p className="text-purple-300 mb-2">Especialista em Digital</p>
              <p className="text-white/70 text-sm">
