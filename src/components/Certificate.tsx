...
export default function Certificate({
  ...
  return (
    <div className="w-[800px] h-[600px] bg-amber-100 rounded-lg shadow-xl p-8 relative overflow-hidden border border-amber-300">
      {/* Subtle texture overlay - adjusted */}
      <div className="absolute inset-0 opacity-40 pointer-events-none" style={{ backgroundImage: 'linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.05) 50%, transparent 100%), radial-gradient(circle at center, rgba(0,0,0,0.05) 0%, transparent 75%)', backgroundSize: '100% 100%, 50px 50px' }}></div>
      ...
      <div className="text-center mb-8 relative">
        ...
        <div className="absolute top-0 left-0 mt-4 ml-8">
          <Image
            src="/images/logocomuniquese.png" // Caminho do logo corrigido
